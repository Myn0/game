...
monster = Enemy('cyborg.png',2,win_w - 80,280)
gold = GameSprite('treasure.png',0, win_w - 120,win_h - 80)

wall1= Wall(132,221,213,20,100,100,10)
wall2 = Wall(212,234,132,100,20,100,10)
wall3 =Wall(124,255,221,20,100,200,10)
...
win = font.render('ладно',True,(127,45,80))
lose = font.render('не ладно',True,(231,123,123))
while game:
    for e in event.get():
        if e.type == QUIT:
            game = False
